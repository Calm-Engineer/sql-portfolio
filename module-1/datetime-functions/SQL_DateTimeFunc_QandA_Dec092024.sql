...
-- so year-wise, month-wise, week-wise, weekend/weekday and the 2023-specific
-- query all have real data to work with).
-- Rows 13-18 use CURDATE()-relative dates so "current year/month",
-- "last 20 days" and "today" queries return results no matter when this
